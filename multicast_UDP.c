...
#define PROGRAM_NAME "Multicasting localhost com threads"
#define AUTHOR \
...
-------------------------Header-----------------------------------------------------|
 ...
 DESCRIÇÃO 	   : Envia e recebe mensagem em localhost utilizando multicasting UDP
		     com threads
 GITHUB		   : https://github.com/debmarlon/Multicast-UDP-
...
void *Receive(void *args){
	  ...
	  while(1){          
		    ...
		    /* Recebendo a menssagem e enviando
		       para output  */
...
int main(int argc, char *argv[]) {
	  ...
	  /* Associando endereço multicast ao socket */
	  if ((
		bind(
		     isock,
